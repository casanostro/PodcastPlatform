  ...
  const journalEntries: JournalEntry[] = [
    ...
    },
    {
      ...
      content: [
        ...
        "",
        "TABLEAU D'ANALYSE DE L'INCIDENT:",
        "+----------------+--------------------+---------------------+",
        "| COMPOSANT      | TEMPS D'ARRÊT      | IMPACT FINANCIER    |",
        "+----------------+--------------------+---------------------+",
        "| XJ-42 MODULE A | 04:12:36           | 126,450 EUR         |",
        "| XJ-42 MODULE B | 02:45:12           | 78,340 EUR          |",
        "| LIGNE ASSEMBL. | 01:30:00           | 25,210 EUR          |",
        "+----------------+--------------------+---------------------+",
        "| TOTAL          | 08:27:48           | 230,000 EUR         |",
        "+----------------+--------------------+---------------------+",
        "",
        "Mesures immédiates:",
